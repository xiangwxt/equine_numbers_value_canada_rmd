...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1. Historical number of horses per province in Canada between 1940 - 1972.", out.width = "100%"}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
knitr::kable(max_horses, caption = "Table 1. Range of the number of horses for each provinces at any time point between 1940 - 1972")
```
